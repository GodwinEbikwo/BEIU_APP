...
function Staff({ navigation, route }) {
  const [modalVisible, setModalVisible] = useState(false);

  const toogleContactPage = () => {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <Text style={styles.paragraph}>
          ...
          tincidunt vel, eleifend et est. Vulputate. Aenean augue eros, viverra
          egestas tristique at, aliquam et lacus. Etiam suscipit varius ligula,
          at tempus lectus pellentesque ac. Donec maximus euismod velit ultrices
          imperdiet. Suspendisse sem tellus, accumsan quis faucibus sed, tempus
          id urna. Phasellus id mauris aliquam, elementum mi eu, vestibulum
          nisl. Sed quis fringilla lorem.
        </Text>
        ...
        <Modal
          ...
          onRequestClose={toogleContactPage}
        >
          <BlurView
            tint="dark"
            intensity={100}
          ...
          >
            ...
            >
              ...
              >
                ...
                <Text style={styles.politeText}>Don't forget to be polite</Text>
              </View>
              ...
              <TouchableOpacity onPress={toogleContactPage}>
                <View
                  style={{
                    justifyContent: "center",
                    alignItems: "center",
